...
Create an archive blog.tar.gz (make sure archive format is tar.gz) of /usr/src/devops/ directory ( present on each app server ) and copy it to /opt/devops/ directory on all app servers. The user and group owner of archive blog.tar.gz should be tony for App Server 1, steve for App Server 2 and banner for App Server 3.
